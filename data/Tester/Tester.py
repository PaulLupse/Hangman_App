...
from data.Tester.TestGenerator import TestGenerator as TestGen
...
class Tester:
    ...
    def __init__(self, test_files_folder, default_dict_file, default_output_file):
        ...
        self.test_generator = TestGen(self.test_files_folder_path, default_dict_file)
    ...
    def gui_loop(self):
        ...
        while True:
            ...
            match action:
                ...
                case "1":
                    self.clear_console()
                    self.test_generator.generate_test(10000)
                ...
                case "2":
                    ...
                    if file_to_test != '':
                        guesser = WordGuesser(file_to_test, self.default_output_file, self.default_dict_file)
    ...
    # afiseaza toate fisierele dintr-un folder si returneaza cel ales de utilizator
    @staticmethod
